...
# Elastic Net regression classification of the MNIST database, part 1
...
# Train an Elastic Net regression classifier
model = sklearn.linear_model.ElasticNet(alpha=0.01, l1_ratio=0.1)
